  ...
  return (
    ...
    function (_Element) {
      ...
      function _class(view, parent, data, arg) {
        ...
        _this = _possibleConstructorReturn(this, (_class.__proto__ || Object.getPrototypeOf(_class)).call(this, view, parent, data, arg)); // computed position relative parent block or global

        _this.global = false; // position margin
